...
<body id="corpo-1">
  <main>
    <article>
      <div id="box-1">
        <h2 id="title-0"> BEM VINDO AO BANCO DO ANDRE </h2>
      </div>
      <div id="box-2">
        <h3 id="forms-1" name="titulo formulario"> FAÇA LOGIN NO SISTEMA </h3>
        <br><br>
        <form method="POST" action="">
          <!--Criado um Metodo de envio POST, sem action ainda-->
  ...
  <footer>
    <div class="contents_footer">
      <div class="content">
        <p><a href="#" onclick="subcontent(0)">Conteúdo</a></p>
      ...
      <div class="content">
        <p><a href="#" onclick="subcontent(1)">Conteúdo</a></p>
      ...
      <div id="subcontent3" class="content">
        <p><a href="#" onclick="subcontent(2)">Conteúdo</a></p>
